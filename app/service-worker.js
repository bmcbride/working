...
const PRECACHE = 'precache-04-21-20.2';
...
const PRECACHE_URLS = [
  ...
  'assets/img/gps_not_fixed-black-18dp.svg',
  'assets/img/gps_fixed-black-18dp.svg',
  'assets/img/more_horiz-black-18dp.svg',
  'assets/img/help-white-18dp.svg',
  'assets/img/map-white-18dp.svg',
  'assets/img/share-white-18dp.svg',
  'assets/img/zoom_out_map-white-18dp.svg',
  ...
  'assets/vendor/materialize-1.0.0/css/materialize.min.css',
  'assets/vendor/materialize-1.0.0/js/materialize.min.js',
  'assets/css/app.css',
  'assets/js/app.js'
];
...
self.addEventListener('activate', event => {
  const currentCaches = [PRECACHE, 'cached-maps'];
  event.waitUntil(
